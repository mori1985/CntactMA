                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-md-11">
                    <ul className="list-group">
                      ...
                      <li className="list-group-item list-group-item-dark">
                        شماره ای پی فون :{" "}
                        <span className="fw-bold">{contact.ipphone}</span>
                      </li>
                      <li className="list-group-item list-group-item-dark">
                        شماره داخلی :{" "}
                        <span className="fw-bold">{contact.dakheli}</span>
                      </li>
                      <li className="list-group-item list-group-item-dark">
                        شماره ثابت :{" "}
                        <span className="fw-bold">{contact.sabet}</span>
                      </li>
                      <li className="list-group-item list-group-item-dark">
                        شماره ثابت :{" "}
                        <span className="fw-bold">{contact.sabet}</span>
                      ...
                      <li className="list-group-item list-group-item-dark">
                        اداره  مربوطه :{" "}
                        <span className="fw-bold">{contact.edareh}</span>
                      </li>
                      <li className="list-group-item list-group-item-dark">
                        سمت    :{" "}
                        <span className="fw-bold">{contact.semat}</span>
                      </li>
