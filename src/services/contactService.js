...
const SERVER_URL = "https://contactapi.m.1985-morteza-mahmoudi.ir";
...
// @route POST http://localhost:9000/requestforcreateContact
export const createContact = (contact) => {
  const url = `${SERVER_URL}/requestforcreateContact`;
  return axios.post(url, contact);
};

// @desc  edit a Contact
// @route POST http://localhost:9000/ReqestForEditContact
export const ReqestForEditContact = (contact) => {
  const url = `${SERVER_URL}/ReqestForEditContact`;
  return axios.post(url, contact);
};
